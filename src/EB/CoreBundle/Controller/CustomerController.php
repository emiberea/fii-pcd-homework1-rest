...
use EB\CoreBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EBCoreBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("EBCoreBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EBCoreBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EBCoreBundle:Customer:edit.html.twig")
     */
