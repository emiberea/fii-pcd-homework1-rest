...
use EB\CoreBundle\Form\OrderType;
...
class OrderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EBCoreBundle:Order')->findAll();
     ...
     * @Method("POST")
     * @Template("EBCoreBundle:Order:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EBCoreBundle:Order')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EBCoreBundle:Order:edit.html.twig")
     */
